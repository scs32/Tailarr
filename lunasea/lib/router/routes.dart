...
import 'package:lunasea/router/routes/jellyfin.dart';
...
enum LunaRoutes {
  ...
  jellyfin('jellyfin', root: JellyfinRoutes.HOME),
  ...
  tailarrServer('tailarr_server', root: TailarrServerRoutes.HOME),
