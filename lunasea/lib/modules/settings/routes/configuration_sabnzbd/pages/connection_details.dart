...
class _State extends State<ConfigurationSABnzbdConnectionDetailsRoute>
  ...
  Widget? _bottomActionBar() {
    if (ServerDrivenConnection.shouldRequestAccess('sabnzbd')) return null;
    return LunaBottomActionBar(
      actions: [
        if (!ServerDrivenConnection.isManaged('sabnzbd')) _testConnection(),
        _shareConfiguration(),
      ],
    );
  }
  ...
  Widget _testConnection() {
    return LunaButton.text(
      ...
      onTap: () async {
        ...
        final blocked = await SsrfGuard.guard(_profile.sabnzbdHost);
        if (blocked != null) {
