...
class _State extends State<ConfigurationLidarrConnectionDetailsRoute>
  ...
  Widget? _bottomActionBar() {
    if (ServerDrivenConnection.shouldRequestAccess('lidarr')) return null;
    return LunaBottomActionBar(
      actions: [
        if (!ServerDrivenConnection.isManaged('lidarr')) _testConnection(),
        _shareConfiguration(),
      ],
    );
  }
  ...
  Widget _testConnection() {
    return LunaButton.text(
      ...
      onTap: () async {
        ...
        final blocked = await SsrfGuard.guard(_profile.lidarrHost);
        if (blocked != null) {
