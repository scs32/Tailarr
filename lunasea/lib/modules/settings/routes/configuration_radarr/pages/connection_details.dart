...
class _State extends State<ConfigurationRadarrConnectionDetailsRoute>
  ...
  Widget? _bottomActionBar() {
    if (ServerDrivenConnection.shouldRequestAccess('radarr')) return null;
    return LunaBottomActionBar(
      actions: [
        if (!ServerDrivenConnection.isManaged('radarr')) _testConnection(),
        _shareConfiguration(),
      ],
    );
  }
  ...
  Widget _testConnection() {
    return LunaButton.text(
      ...
      onTap: () async {
        ...
        final blocked = await SsrfGuard.guard(_profile.radarrHost);
        if (blocked != null) {
