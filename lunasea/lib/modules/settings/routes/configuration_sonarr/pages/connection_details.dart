...
class _State extends State<ConfigurationSonarrConnectionDetailsRoute>
  ...
  Widget? _bottomActionBar() {
    if (ServerDrivenConnection.shouldRequestAccess('sonarr')) return null;
    return LunaBottomActionBar(
      actions: [
        if (!ServerDrivenConnection.isManaged('sonarr')) _testConnection(),
        _shareConfiguration(),
      ],
    );
  }
  ...
  Widget _body() {
    return LunaBox.profiles.listenableBuilder(
      builder: (context, _) => LunaListView(
        ...
        children: ServerDrivenConnection.isManaged('sonarr')
  ...
  Widget _testConnection() {
    return LunaButton.text(
      ...
      onTap: () async {
        ...
        final blocked = await SsrfGuard.guard(_profile.sonarrHost);
        if (blocked != null) {
